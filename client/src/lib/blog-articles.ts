...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    seoTitle: 'Termas Cerca de Frutillar: Tradicionales vs Biopiscinas Naturales - Cancagua',
    excerpt: 'Si buscas termas cerca de Frutillar o Puerto Varas, esta guía compara las termas tradicionales del sur con alternativas naturales como las biopiscinas geotermales de Cancagua.',
    seoDescription: 'Guía para elegir termas cerca de Frutillar y Puerto Varas. Compara termas tradicionales del sur de Chile con biopiscinas naturales, hot tubs y experiencias geotermales.',
    keywords: 'termas cerca de frutillar, termas frutillar, termas cerca de puerto varas, termas tradicionales vs naturales, biopiscinas vs termas, experiencia termal natural, termas sur chile diferencias',
    image: 'https://res.cloudinary.com/dhuln9b1n/image/upload/v1770309133/cancagua/images/blog/termas-geometricas-hero.webp',
