...
export default function PasesReconecta() {
  ...
  const pases = [
    ...
    },
    {
      ...
      duration: "6.5 horas",
      image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/pase-reconecta-sauna.png",
    ...
    },
    {
      ...
      duration: "6 horas",
      image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/pase-reconecta-masaje-1.png",
    ...
    },
    {
      ...
      duration: "6+ horas",
      image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/pase-reconecta-masaje-2.png",
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center text-white space-y-6">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-white/90">
            Experiencias diseñadas para tu bienestar integral: Hot-Tubs privados, Biopiscinas geotermales, masajes y actividades en la naturaleza
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-amber-50 to-stone-100">
        <div className="container text-center space-y-6">
          ...
          <p className="text-lg text-stone-600 max-w-2xl mx-auto">
            Nuestro equipo está disponible para asesorarte y ayudarte a encontrar la experiencia perfecta para ti
          </p>
