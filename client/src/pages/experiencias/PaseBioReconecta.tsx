        ...
        <div className="relative z-10 container pb-16 text-white">
          <div className="max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
              ...
              <span className="text-sm font-medium">Experiencia Bio-Reconecta</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-josefin font-bold tracking-tight">
              Pase BioReconecta 6hrs
            </h1>
            <p className="text-2xl text-white/90">
              Biopiscinas + Masaje + Kayak o Yoga
            </p>
            <p className="text-lg text-white/80 leading-relaxed">
              ¡Disfruta de la experiencia Bio-Reconecta en nuestras piscinas naturales diseñadas de manera sostenible, que utilizan plantas y sistemas ecológicos para mantener el agua cristalina, sin químicos y en armonía con el medio ambiente!
            </p>
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                ...
                <span className="font-semibold">Sin químicos</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-stone-600">
                El Pase Bio-Reconecta tiene una estadía de 6 horas aproximadamente
              </p>
            </div>
          ...
          <Card className="border-0 shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-br from-cyan-600 to-blue-600 p-12 text-center text-white space-y-6">
              ...
              <h2 className="text-4xl font-josefin font-bold">
                ¡Reserva tu experiencia Bio-Reconecta!
              </h2>
              <p className="text-xl text-white/90 max-w-2xl mx-auto">
                Ven a conocer nuestras Biopiscinas, un espacio donde la naturaleza y comodidad se encuentran
              </p>
