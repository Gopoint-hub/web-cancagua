...
import { 
  Clock, Users, Sparkles, Check, Info, 
  Waves, Heart, Droplets, Coffee, Calendar
} from "lucide-react";
import { AutoTranslateProvider, T } from "@/components/AutoTranslate";

export default function PaseBioReconecta() {
  const includes = [
  ...
  const importantInfo = [
    ...
    "El horario de masajes queda sujeto a disponibilidad de agenda, nos comunicaremos contigo para entregarte tu itinerario",
      ...
      <div className="min-h-screen bg-gradient-to-b from-cyan-50 to-white">
        ...
        <section className="relative h-[70vh] flex items-end overflow-hidden">
          <div 
            ...
            style={{
              backgroundImage: "url('https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/pase-reconecta-masaje-1.png')",
            }}
          >
          ...
          <div className="relative z-10 container pb-16 text-white">
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-2xl text-white/90">
                <T>Biopiscinas + Masaje + Kayak o Yoga</T>
              </p>
              <p className="text-lg text-white/80 leading-relaxed">
                <T>¡Disfruta de la experiencia Bio-Reconecta en nuestras piscinas naturales diseñadas de manera sostenible, que utilizan plantas y sistemas ecológicos para mantener el agua cristalina, sin químicos y en armonía con el medio ambiente!</T>
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                  <Clock className="h-5 w-5" />
                  <span className="font-semibold"><T>6 horas aprox.</T></span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                ...
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
                  ...
                  <span className="font-semibold"><T>Sin químicos</T></span>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8 space-y-6">
                <p className="text-lg text-stone-700 leading-relaxed">
                  <T>Son piscinas naturales diseñadas de manera sostenible, que utilizan plantas y sistemas ecológicos para mantener el agua cristalina, sin químicos y en armonía con el medio ambiente. La temperatura varía entre 36 a 40 grados.</T>
                </p>
                <p className="text-lg text-stone-700 leading-relaxed">
                  <T>Nuestras Biopiscinas están pensadas para brindarte un entorno relajante, rodeado de paisajes espectaculares. Además, contamos con baños, ducha y camarín completamente equipados para garantizar tu comodidad.</T>
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              <div className="text-center space-y-4">
                ...
                <p className="text-lg text-stone-600">
                  <T>El Pase Bio-Reconecta tiene una estadía de 6 horas aproximadamente</T>
                </p>
              </div>
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-xl text-stone-600 leading-relaxed">
                <T>Además estarás al costado de nuestro Café & Beach Bar con una exquisita carta para deleitarte durante tu estadía</T>
              </p>
            </div>
          </div>
        </section>
            ...
            <Card className="border-0 shadow-2xl overflow-hidden">
              <div className="bg-gradient-to-br from-cyan-600 to-blue-600 p-12 text-center text-white space-y-6">
                ...
                <p className="text-xl text-white/90 max-w-2xl mx-auto">
                  <T>Ven a conocer nuestras Biopiscinas, un espacio donde la naturaleza y comodidad se encuentran</T>
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  <a 
                    href="https://reservas.cancagua.cl/cancaguaspa/s/dc3b0862-ea5e-4809-81c6-450014ae8f87"
                    target="_blank"
