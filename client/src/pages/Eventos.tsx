...
export default function Eventos() {
  // Datos de ejemplo - más adelante se sincronizarán con Skedu API
  const eventos = [
    {
      id: 1,
      titulo: "Sonoterapia con Cuencos Tibetanos",
      descripcion:
        "Sesión de sanación sonora con cuencos tibetanos en un ambiente natural único.",
      fecha: "2026-01-25",
      hora: "19:00",
      duracion: "90 minutos",
      cupos: 15,
    ...
    },
    {
      ...
      descripcion:
        "Práctica intensiva de yoga y meditación con vista al lago. Todos los niveles.",
      fecha: "2026-02-01",
      hora: "10:00",
      duracion: "3 horas",
      cupos: 20,
    ...
    },
    {
      ...
      descripcion:
        "Música en vivo con artistas locales mientras disfrutas de las biopiscinas.",
      fecha: "2026-02-08",
      hora: "18:30",
      duracion: "2 horas",
      cupos: 30,
    ...
    },
    {
      ...
      descripcion:
        "Retiro completo de bienestar: yoga, meditación, terapias y alimentación consciente.",
      fecha: "2026-02-15",
      hora: "09:00",
      duracion: "2 días",
      cupos: 12,
        ...
        <section className="relative h-[40vh] md:h-[50vh] overflow-hidden">
          ...
          <div className="relative h-full container flex flex-col items-center justify-center text-center text-white">
            ...
            <p className="text-lg md:text-xl max-w-2xl">
              Experiencias transformadoras: sonoterapia, conciertos, talleres y
              retiros en conexión con la naturaleza
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-lg text-muted-foreground">
                En Cancagua organizamos eventos especiales que combinan
                bienestar, arte y naturaleza. Desde sesiones de sonoterapia
                hasta conciertos acústicos y retiros de fin de semana, cada
                evento está diseñado para ofrecerte una experiencia única e
                inolvidable.
              </p>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {eventos.map((evento) => {
                const cuposStatus = getCuposStatus(
                    ...
                    <CardContent className="flex-1">
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          <span>
                            {evento.cuposDisponibles} de {evento.cupos} cupos
                            disponibles
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-muted-foreground">
            ...
            {eventos.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Suscríbete a nuestro newsletter para enterarte de próximos
                  eventos
                </p>
              </div>
            )}
        ...
        <section className="py-16 bg-muted">
          <div className="container text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              sobre próximos eventos, talleres y retiros
            </p>
            <Button size="lg">Suscribirme al Newsletter</Button>
          </div>
        </section>
      </main>
