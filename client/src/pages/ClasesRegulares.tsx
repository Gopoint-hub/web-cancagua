  ...
  return (
    <div className="min-h-screen bg-[#F4F2ED]">
              ...
              <Card key={index} className="bg-white border-none shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                {classInfo.image ? (
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={classInfo.image}
                      alt={`${classInfo.name} ${classInfo.subtitle}`}
                      className="w-full h-full object-cover"
                      loading="lazy"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#222221]/80 to-transparent" />
                    <div className="absolute bottom-4 left-6 text-white">
                      <h3 className="font-cg-mono text-xl tracking-wide">
                        {classInfo.name}
                      </h3>
      ...
      <section className="py-20 bg-[#222221] text-white">
        <div className="container max-w-4xl text-center">
          <h2 className="font-cg-serif text-3xl md:text-4xl mb-6">
            Pases y Membresías
          </h2>
