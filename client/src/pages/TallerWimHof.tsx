          ...
          <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container text-center text-white px-4">
              ...
              <p className="text-lg md:text-xl max-w-2xl mx-auto mb-8 text-white/80">
                <T>Una experiencia profunda de respiración, mente y frío guiada por el único Instructor Avanzado del Método Wim Hof en Chile</T>
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 text-white/90">
                  <Calendar className="h-5 w-5" />
                  <span className="text-lg"><T>Sábado 31 de Enero 2026</T></span>
                </div>
                <div className="flex items-center gap-2 text-white/90">
              ...
              >
                ...
                >
                  <T>Reservar Mi Cupo</T> - $45.000
                </a>
              </Button>
              <p className="mt-4 text-sm text-white/70"><T>¡Solo quedan 5 cupos disponibles!</T></p>
            </div>
          </section>
            ...
            <div className="container">
              <div className="max-w-4xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <img
                      src="https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/alan-iceman.png"
                      alt="Alan IceMan"
          ...
          <section className="py-20 bg-[#D3BC8D]">
            <div className="container text-center">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                <T>Únete a esta experiencia única y descubre el poder del Método Wim Hof de la mano del mejor instructor de Chile</T>
              </p>
              <div className="flex flex-col items-center gap-4">
                ...
                >
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <T>Reservar Mi Cupo Ahora</T>
                  </a>
                </Button>
                <p className="text-white/80 text-lg">
                  <T>Inversión</T>: <span className="font-medium text-white">$45.000 CLP</span>
                </p>
              </div>
            </div>
          </section>
