...
import { Thermometer, Clock, Users, UtensilsCrossed, TreePine, Droplets, Leaf, Heart } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F1E7D9]">
      ...
      <section className="relative h-[80vh] min-h-[600px]">
        <div className="absolute inset-0">
          <img
            src="https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/05_hottubs-hero.png"
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-4xl text-center">
          ...
          <p className="font-['Fira_Sans'] text-lg text-[#666] leading-relaxed mb-6">
            Contamos con seis espacios privados, cada uno con terrazas que incluyen ducha y cambiadores. 
            Disfrutarás de una <strong>estadía de 4 horas</strong>, considerando 2.5 horas en el agua y 
            1.5 horas para disfrutar de nuestra infraestructura de cafetería, playa, baños y amenities.
          </p>
          <p className="font-['Fira_Sans'] text-lg text-[#666] leading-relaxed mb-10">
            Cada hot tub es <strong>especial</strong>, y está inmerso en un entorno natural para que 
            disfrutes de cada experiencia, ya sea con vista al bosque nativo o a la bahía de Frutillar.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <Card className="bg-white border-none shadow-sm">
              <CardContent className="p-8 text-center">
                <Thermometer className="h-10 w-10 text-[#D3BC8D] mx-auto mb-4" />
                <h3 className="font-['Josefin_Sans'] text-sm tracking-wider uppercase text-[#3a3a3a] mb-2">
                  Tº del agua
                </h3>
                <p className="font-['Cormorant_Garamond'] text-2xl text-[#D3BC8D]">40 - 41º</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white border-none shadow-sm">
              <CardContent className="p-8 text-center">
                <Clock className="h-10 w-10 text-[#D3BC8D] mx-auto mb-4" />
                <h3 className="font-['Josefin_Sans'] text-sm tracking-wider uppercase text-[#3a3a3a] mb-2">
                  Duración
                </h3>
                <p className="font-['Cormorant_Garamond'] text-2xl text-[#D3BC8D]">2.5 hrs</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white border-none shadow-sm">
              <CardContent className="p-8 text-center">
                <Users className="h-10 w-10 text-[#D3BC8D] mx-auto mb-4" />
                <h3 className="font-['Josefin_Sans'] text-sm tracking-wider uppercase text-[#3a3a3a] mb-2">
                  Capacidad máx.
                </h3>
                <p className="font-['Cormorant_Garamond'] text-2xl text-[#D3BC8D]">10 personas</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white border-none shadow-sm">
              <CardContent className="p-8 text-center">
                <UtensilsCrossed className="h-10 w-10 text-[#D3BC8D] mx-auto mb-4" />
                <h3 className="font-['Josefin_Sans'] text-sm tracking-wider uppercase text-[#3a3a3a] mb-2">
                  Tablas y bebestibles
                </h3>
                <p className="font-['Cormorant_Garamond'] text-2xl text-[#D3BC8D]">Para compartir</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-['Fira_Sans'] text-lg text-[#666] leading-relaxed mb-6">
                Familia, eventos de empresa, celebraciones de cumpleaños, matrimonio y mucho más. 
                Conecta con la naturaleza y disfruta de un lugar único para adquirir <strong>experiencias inolvidables</strong>.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img
                src="https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/06_cafeteria-hero.jpg"
