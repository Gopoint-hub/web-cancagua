    ...
    <main className="bg-white min-h-screen pt-32 pb-20">
      <div className="container max-w-4xl mx-auto px-4 md:px-6">
        ...
        <div className="prose prose-stone max-w-none text-[#827D78] leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-light text-[#222221] mt-10 mb-4">¿Cómo solicitar la eliminación de tus datos?</h2>
          
          <p>Para eliminar tus datos, por favor sigue estos pasos:</p>

          <div className="bg-[#FCF9F9] p-6 rounded-lg border border-[#4B5872]/30 mt-6 mb-8">
            <h3 className="text-xl font-medium text-[#222221] mb-4">Paso 1: Envíanos un correo electrónico</h3>
            <p className="mb-4">
          ...
          <div className="bg-[#FCF9F9] p-6 rounded-lg border border-[#4B5872]/30 mb-8">
            <h3 className="text-xl font-medium text-[#222221] mb-4">Paso 2: Confirmación y Procesamiento</h3>
            <p>
          ...
          <h2 className="text-2xl font-light text-[#222221] mt-10 mb-4">Instrucciones específicas para usuarios de Facebook/Meta</h2>
          <p>
