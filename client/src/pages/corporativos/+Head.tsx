...
export default function Head() {
  const seoData = {
    ...
    description:
      "Jornadas corporativas y team building en Cancagua, Frutillar. Programas de bienestar para equipos, biopiscinas geotermales, hot tubs, talleres y gastronomía.",
    keywords:
      "jornadas corporativas frutillar, actividades para empresas, team building lago llanquihue, retiros corporativos frutillar, bienestar para equipos",
  ...
  const faqSchema = {
    ...
    mainEntity: FAQS_CORPORATIVOS.map(faq => ({
      "@type": "Question",
      name: faq.question,
      acceptedAnswer: {
        "@type": "Answer",
  ...
  const serviceSchema = {
    ...
    name: "Jornadas corporativas y team building en Cancagua",
    serviceType: "Jornadas y actividades para empresas",
