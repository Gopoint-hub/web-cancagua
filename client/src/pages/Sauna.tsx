...
export default function Sauna() {
  ...
  const antesDeVisita = [
    ...
    "Ubicación privilegiada con vista al Lago Llanquihue",
    "Arriendo de batas y toallas",
    "Recomendamos hidratarse antes y después de la sesión",
    "No recomendado para personas con problemas cardiovasculares o embarazadas",
  ];

  return (
    <AutoTranslateProvider pageId="sauna">
        ...
        <main className="flex-1">
          ...
          <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0">
              <img
                src="https://d2xsxph8kpxj0f.cloudfront.net/310519663288636259/b6AHokZVYJSFV94d2D2ybb/cancagua/images/sauna-nativo-hero.png"
            ...
            <div className="relative z-10 container text-center text-white px-4">
              ...
              <p className="text-lg md:text-xl max-w-2xl mx-auto mb-8 text-white/90">
                <T>Disfruta de una hora de relajación y conexión a orillas del Lago Llanquihue. Un espacio de calor envolvente y renovación profunda.</T>
              </p>
              <Button
                size="lg"
                  ...
                  <div className="flex items-start gap-4 mb-6 p-4 bg-red-50 rounded-lg border border-red-200">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-600">
                        <T>Para mantener la calidad de nuestras instalaciones</T>
                      </p>
                    </div>
                  </div>
          ...
          <section className="py-20 bg-[#D3BC8D]">
            <div className="container text-center">
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                <T>Reserva tu sesión de sauna y experimenta la relajación profunda que tu cuerpo necesita</T>
              </p>
              <Button
                size="lg"
